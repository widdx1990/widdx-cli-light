...
class WiddxAnalyzer:
    """Call the WIDDX Cortex API for code analysis."""
...
async def handle_pull_request(event: str, payload: dict):
    ...
    try:
        ...
        full_review = (
            f"## 🤖 WIDDX Cortex — Automated Code Review\n\n"
            f"{review}\n\n"
            f"---\n*🤖 Generated by [WIDDX Cortex](https://github.com/widdx1990/widdx-cli-light) "
